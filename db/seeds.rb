...
cowboys = Team.create!(city: "Dallas", nickname: "Cowboys", colors: "Blue, Silver, White", email: "dallas@cowboys.com", logo: File.open("https://s3.us-east-2.amazonaws.com/dbc-space-app/teams/logos/000/000/001/original/dallas.png"))
eagles = Team.create!(city: "Philidelphia", nickname: "Eagles", colors: "Dark Green, Gold, White", email: "philidelhpia@eagles.com", logo: File.open("https://s3.us-east-2.amazonaws.com/dbc-space-app/teams/logos/000/000/002/original/phili.png"))
giants = Team.create!(city: "New York", nickname: "Giants", colors: "Dark Blue, Red, White", email: "newyork@giants.com", logo: File.open("https://s3.us-east-2.amazonaws.com/dbc-space-app/teams/logos/000/000/003/original/giants.png"))
redskins = Team.create!(city: "Washington D.C.", nickname: "Redskins", colors: "Teal, Black, Gold, White", email: "washington@redskins.com", logo: File.open("https://s3.us-east-2.amazonaws.com/dbc-space-app/teams/logos/000/000/004/original/redskins.png"))
texans = Team.create!(city: "Houston", nickname: "Texans", colors: "Nave, Red, Silver, White", email: "houston@texans.com", logo: File.open("https://s3.us-east-2.amazonaws.com/dbc-space-app/teams/logos/000/000/005/original/texans.png"))
